...
auth()->user()->getRoleName->role_short_name=='rm' ) && $cnts==1)
    ...
    <div class="form-group">
        <div class="col-md-offset-4 col-md-8">
            @if (auth()->user()->getRoleName->role_short_name=='ho')
                {!! Form::submit('Accept', array('class' => "btn btn-success",'id' => 'multi_accept_claim')) !!} &nbsp;
            ...
            {!! Form::submit('Decline', array('class' => "btn btn-danger",'id' => 'multi_decline_claim')) !!} &nbsp;
            @endif
...
auth()->user()->getRoleName->role_short_name=='br')
<div class="card-footer" id="create_claim_btn">
    <a href="{{ url('claim_incentive/create') }}" class="btn btn-app bg-danger float-right">
